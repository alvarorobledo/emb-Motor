...
OBJECTS += Crypto/cipher/AES.o
OBJECTS += Crypto/cipher/BlockCipher.o
OBJECTS += Crypto/cipher/Cipher.o
OBJECTS += Crypto/cipher/DES.o
OBJECTS += Crypto/cipher/RC4.o
OBJECTS += Crypto/cipher/StreamCipher.o
OBJECTS += Crypto/cipher/TDES.o
OBJECTS += Crypto/hash/HMAC.o
OBJECTS += Crypto/hash/HashAlgorithm.o
OBJECTS += Crypto/hash/MD2.o
OBJECTS += Crypto/hash/MD4.o
OBJECTS += Crypto/hash/MD5.o
OBJECTS += Crypto/hash/SHA1.o
OBJECTS += Crypto/hash/SHA224.o
OBJECTS += Crypto/hash/SHA256.o
OBJECTS += Crypto/hash/SHA2_32.o
OBJECTS += Crypto/hash/SHA2_64.o
OBJECTS += Crypto/hash/SHA384.o
OBJECTS += Crypto/hash/SHA512.o
OBJECTS += main.o
...
INCLUDE_PATHS += -I../
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I../Crypto
INCLUDE_PATHS += -I../Crypto/cipher
INCLUDE_PATHS += -I../Crypto/hash
...
CC      = 'arm-none-eabi-gcc' '-std=gnu99' '-c' '-Wall' '-Wextra' '-Wno-unused-parameter' '-Wno-missing-field-initializers' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-funsigned-char' '-MMD' '-fno-delete-null-pointer-checks' '-fomit-frame-pointer' '-Os' '-g1' '-DMBED_RTOS_SINGLE_THREAD' '-mcpu=cortex-m4' '-mthumb' '-mfpu=fpv4-sp-d16' '-mfloat-abi=softfp'
CPP     = 'arm-none-eabi-g++' '-std=gnu++98' '-fno-rtti' '-Wvla' '-c' '-Wall' '-Wextra' '-Wno-unused-parameter' '-Wno-missing-field-initializers' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-funsigned-char' '-MMD' '-fno-delete-null-pointer-checks' '-fomit-frame-pointer' '-Os' '-g1' '-DMBED_RTOS_SINGLE_THREAD' '-mcpu=cortex-m4' '-mthumb' '-mfpu=fpv4-sp-d16' '-mfloat-abi=softfp'  '-O0' '-g' '-fpermissive'
...
C_FLAGS += -DTARGET_M4
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1520012807.31
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1520012807.31
...
ASM_FLAGS += -I.
ASM_FLAGS += -ICrypto
ASM_FLAGS += -ICrypto/cipher
ASM_FLAGS += -ICrypto/hash
ASM_FLAGS += -Imbed/.
